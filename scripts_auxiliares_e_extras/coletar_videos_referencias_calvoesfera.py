...
with open('videos_referencias_calvoesfera_filtrado.csv', 'w', newline='', encoding='utf-8') as arquivo_csv:
    escritor = csv.writer(arquivo_csv)
    escritor.writerow(cabecalho)
    escritor.writerows(dados_csv_filtrados)

print(f"Exportação concluída: {len(dados_csv_filtrados)} vídeos filtrados salvos em videos_referencias_calvoesfera_filtrado.csv")
